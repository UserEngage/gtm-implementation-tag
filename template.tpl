...

{
  ...
  "description": "It’s a simple way to enable tracking and interacting with the User.com chat widget. Users’ page views will be recognized and send to the User.com application.",
  "containerContexts": [
    "WEB"
  ]
}
